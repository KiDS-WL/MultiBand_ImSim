...
# @Last Modified time: 2023-02-20 11:38:27
...
#### step2 D1
python QC_step2.py\
    --inpath /disks/shear16/ssli/KiDS/K1000_forSKiLLS/kids_photo_LF_321_shear_noSG_noWeiCut_newCut_817tiles_A1.feather.A2.feather\
    --outprefix ./QC_alphaRecal_step2_D1\
    --col_ZB Z_B\
    --col_R R\
    --col_snr model_SNratio\
    --cols_psf_e12 PSF_e1 PSF_e2\
    --cols_e12_before autocal_e1 autocal_e2\
    --cols_e12_after AlphaRecalD1_e1 AlphaRecalD1_e2\
    --col_weight_after AlphaRecalC_weight\
    --Nbins_R_snr 30 30\
    --Z_B_edges 0.1 0.3 0.5 0.7 0.9 1.2 2.0
# QC plot for alpha1 in SNR-R plane saved as ./QC_alphaRecal_step2_D1_SNR_R_alpha1.png
# QC plot for alpha2 in SNR-R plane saved as ./QC_alphaRecal_step2_D1_SNR_R_alpha2.png
# No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
# QC plot for alpha in ZB bins saved as ./QC_alphaRecal_step2_D1_ZBbins.png
# Elapsed:9:56.25,User=1955.786,System=8487.058,CPU=1751.4%.

#### step2 D2
python QC_step2.py\
    --inpath /disks/shear16/ssli/KiDS/K1000_forSKiLLS/kids_photo_LF_321_shear_noSG_noWeiCut_newCut_817tiles_A1.feather.A2.feather\
    --outprefix ./QC_alphaRecal_step2_D2\
    --col_ZB Z_B\
    --col_R R\
    --col_snr model_SNratio\
    --cols_psf_e12 PSF_e1 PSF_e2\
    ...
    --Nbins_R_snr 30 30\
    --Z_B_edges 0.1 0.3 0.5 0.7 0.9 1.2 2.0
# QC plot for alpha1 in SNR-R plane saved as ./QC_alphaRecal_step2_D2_SNR_R_alpha1.png
# QC plot for alpha2 in SNR-R plane saved as ./QC_alphaRecal_step2_D2_SNR_R_alpha2.png
# No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
# QC plot for alpha in ZB bins saved as ./QC_alphaRecal_step2_D2_ZBbins.png
# Elapsed:5:04.06,User=1770.023,System=7683.492,CPU=3109.0%.
