# -*- coding: utf-8 -*-
# @Author: lshuns
# @Date:   2022-09-07 08:35:53
# @Last Modified by:   lshuns
# @Last Modified time: 2022-10-12 15:22:01

### m difference by variable shear simulations
...
outpath = "./plots/dm_var.pdf"
# outpath = "show"
inpath_list = ['../correction_varShear_PSFmodelling/outputs/dm_forBlending_dz0p1.csv']
...
XLABEL = r"$\Delta \bar{m}_{\rm blending}$ (varShear - constShear)"
YLIM = [0.5, 6.5]
...
for i, inpath in enumerate(inpath_list):
    ...
    # error budget shadow
    if ('m_error_budget_list' in locals()) and (i == 0):
...
# for ../correction_varShear_PSFmodelling/outputs/dm_forBlending_dz0p1.csv
# m [-0.0122  -0.0031  -0.0208  -0.01815 -0.01295  0.00045]
# err [0.03445 0.014   0.01185 0.0082  0.00725 0.008  ]
# plot saved in ./plots/dm_var.pdf
# Elapsed:0:10.93,User=8.004,System=28.773,CPU=336.4%.