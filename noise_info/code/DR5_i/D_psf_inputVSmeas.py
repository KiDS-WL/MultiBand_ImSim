# -*- coding: utf-8 -*-
# @Author: lshuns
# @Date:   2022-11-05 12:16:37
# @Last Modified by:   lshuns
# @Last Modified time: 2023-01-20 08:47:45

### correct the measured PSF info using image simulations
...
pixel_scale_final = 0.2 # arcsec/pixel
band_list = ['i1', 'i2']
i_band_list = [10, 11]

# file to save difference info
dpsf_file_list = ['./test/psf_diff_inVSmeas_DR5_i1.csv', 
                    './test/psf_diff_inVSmeas_DR5_i2.csv']

# code for psf measurement
psf2moffat_code = '/disks/shear10/ssli/KiDS_noise_seeing/code/PSFmodelling/psf2moffat'
...
# loop over all bands
for id_band, band in enumerate(band_list):

    i_band = i_band_list[id_band]
    dpsf_file = dpsf_file_list[id_band]
...
# save back to noise file
noise_info.to_csv(noise_file, index=False)
print(f'noise info saved as {noise_file}')

# psf difference saved as ./test/psf_diff_inVSmeas_DR5_i2.csv
# noise info saved as ../../test_noise_dr5_iS.csv
# Elapsed:1:34:22.33,User=9159.560,System=1154.603,CPU=182.1%.