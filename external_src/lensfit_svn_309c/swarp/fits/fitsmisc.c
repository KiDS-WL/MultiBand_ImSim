...
*/
void
error(int num, char *msg1, char *msg2)
{
    fprintf(stderr, "\n> %s%s\n\n", msg1, msg2);
...
warning(char *msg1, char *msg2)
{
    ...
    sprintf(warning_historystr[(nwarning++) % WARNING_NMAX],
            ...
            tm->tm_hour, tm->tm_min, tm->tm_sec, msg1, msg2);
...
warning_history(void)
{
    ...
    str =
        warning_historystr[((nwarning >
                             WARNING_NMAX ? (nwarning % WARNING_NMAX) : 0)
 ...
 ***/
int
wstrncmp(char *cs, char *ct, int n)
{
    int diff, i;
 ...
 ***/
int
findkey(char *str, char *key, int size)
{
    int i;
 ...
 ***/
int
findnkey(char *str, char *key, int size, int nkey)
{
    int i;
