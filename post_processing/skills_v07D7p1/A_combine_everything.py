...
# @Last Modified time: 2023-03-08 09:06:08
...
skills_version_forSave = 'skills_v07D7p1'
...
# out info
outpath = os.path.join(main_dir, f'{skills_version_forSave}_LF_{LF_version}_sharkPhotometry_everything.feather')
...
# combined cata saved to /disks/shear16/ssli/ImSim/output/skills_v07D7/skills_v07D7p1_LF_321_kidsPhotometry_everything.feather
# Elapsed:33:29.68,User=2058.391,System=3485.904,CPU=275.8%.
...
# Number of files: 36
# Total number of source 89303769
# combined cata saved to /disks/shear16/ssli/ImSim/output/skills_v07D7/skills_v07D7p1_LF_321_sharkPhotometry_everything.feather
# Elapsed:13:13.37,User=1474.333,System=3642.926,CPU=645.0%.
