...
# @Last Modified time: 2022-04-21 15:22:49
...
python ../../modules/Run.py 1 2 3 7 --runTag m283p283 --threads 63 --rng_seed 94\
 --cosmic_shear -0.0283 0.0283 -c ./config_part0.ini --sep_running_log 

python ../../modules/Run.py 1 2 3 7 --runTag p283p283 --threads 63 --rng_seed 9401\
 --cosmic_shear 0.0283 0.0283 -c ./config_part0.ini --sep_running_log 

python ../../modules/Run.py 1 2 3 7 --runTag p283m283 --threads 63 --rng_seed 9402\
 --cosmic_shear 0.0283 -0.0283 -c ./config_part0.ini --sep_running_log 

python ../../modules/Run.py 1 2 3 7 --runTag m283m283 --threads 63 --rng_seed 9403\
 --cosmic_shear -0.0283 -0.0283 -c ./config_part0.ini --sep_running_log 
